...
$workExp = [
    'name' => ['Front End Developer','Web Developer','Graphic Designer'],
    'dates' => ['Jan 2015 - ','Mar 2012 - Dec 2014','Jun 2010 - Mar 2012'],
  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <!-- instead: -->
        <?php 
        for ( $i = 0; $i < count($workExp['desc']); $i++){ ?>
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?php echo $workExp['name'][$i];?></b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $workExp['dates'][$i]; 
          if($i==0) echo "<span class=\"w3-tag w3-teal w3-round\">Current</span>";
          ?></h6>
          <p><?php echo $workExp['desc'][$i]; ?></p>
          <hr>
        </div>
        <?php  } ?> 
      </div>
